<script>
    $(document).ready(function(){
        ...
        $(document).on('click', "#showModal", function(e){
            $.post("<?php echo WEB_ROOT.'admin-panel/execute/loadforms.php'; ?>", {form:'caterer'}, function(data){
                $("#formModal").find(".modal-title").text("Add Caterer");
        ...
        $(document).on('click', "#editModal", function(e){
            $.post("<?php echo WEB_ROOT.'admin-panel/execute/loadforms.php'; ?>", {form:'caterer', caterers_id : $(this).attr('data-id')}, function(data){
                $("#formModal").find(".modal-title").text("Update Caterer");
                $("#formModal").find(".modal-body").html(data);    
                $("#formModal").modal('show');
        ...
        $(document).on('click', '#deleteData', function(e){
            ...
            if(confirm("Delete this record?")){
                var caterers_id = $(this).attr('data-id');
                var action    = 'caterers';
                var params = {
                    caterers_id : caterers_id,
                    action : action
                }
